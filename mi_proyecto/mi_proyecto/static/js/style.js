...
document.addEventListener("DOMContentLoaded", () => {
  function swapHearts() {
    ...
    const temp = heart1.innerHTML;
    heart1.innerHTML = heart2.innerHTML;
    heart2.innerHTML = temp;
  ...
  function updateCounter() {
    swapCount++;
    document.querySelector(".counter").textContent = swapCount;
  }

  // Iniciar el intercambio cada 5 segundos
  setInterval(swapHearts, 1000);

  // Intercambiar inmediatamente al cargar la página
